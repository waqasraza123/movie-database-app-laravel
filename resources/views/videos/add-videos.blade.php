@section('content')
    ...
    <div class="row">
        ...
        'id' => 'add-videos-form', 'url' => route('video.store'), 'method' => 'post']) !!}
        <!-- Horizontal Form -->
            <div class="box box-success">
                ...
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            {!! Form::select('keywords', $actors, null, ['class' => 'form-control', 'id' => 'keywords',
                            'required' => true, 'multiple' => true]) !!}
                        </div>
                    </div>
                    <div class="form-group">
...
@endsection
@section('page-header')
    @include('partials.layout.page-header', ['heading' => 'Videos', 'sub' => 'Add a Video'])
@endsection